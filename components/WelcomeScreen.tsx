...
const audioUrls = Object.values(audioModules).map((module: any) => module.default);
                ...
                <div className="space-y-4 w-full">
                    ...
                    <div className="relative">
                        ...
                        {showMicPermission && (
                            ...
                            >
                                <p className="text-white text-sm mb-3 text-center">Allow microphone access to enable voice assistant</p>
                                <button
